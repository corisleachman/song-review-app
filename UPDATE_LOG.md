...
- The observed preview requests returned only successful or redirect statuses in the available runtime window, with no 5xx status. One revised preview log check is required after publication of the allowlist correction.
