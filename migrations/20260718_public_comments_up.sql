-- =============================================================================
-- Public song comments — schema migration (UP)
-- Date: 2026-07-18
-- =============================================================================
-- The public comments routes use the service-role client. Direct access remains
-- disabled for anon/authenticated roles so validation and moderation cannot be
-- bypassed through the Supabase data API.
-- =============================================================================
...
CREATE TABLE IF NOT EXISTS public.public_comments (
  ...
  CONSTRAINT public_comments_author_name_length
    CHECK (char_length(btrim(author_name)) BETWEEN 1 AND 50),
  CONSTRAINT public_comments_body_length
