...
<link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=DM+Sans:wght@300;400;500;600;700&display=swap" rel="stylesheet"><link rel="stylesheet" href="styles.css">
...
async function main() {
  ...
  const prompt = `${brandContext}\n\nARTICLE BRIEF\nPrimary keyword: ${topic.keyword}\nWorking title: ${topic.title}\nAudience: ${topic.audience}\nSearch intent: ${topic.intent}\nExisting article titles to avoid duplicating: ${existingTitles.join('; ') || 'None'}\n\nWrite a genuinely useful article of roughly 1,200 to 1,800 words. Return directAnswer as a self-contained two-to-four sentence answer suitable for search snippets and AI answer engines. Return bodyHtml containing semantic HTML beginning with introductory paragraphs, then H2 and H3 sections. Use question-led headings where natural. Include concrete steps, examples, definitions and explicit recommendations. Do not include H1, head, scripts, styles, markdown fences or an FAQ section inside bodyHtml. Keep the meta description at or below 155 characters. Include 3 to 5 self-contained FAQs separately. Mention The Song Room sparingly and only where relevant.`;
