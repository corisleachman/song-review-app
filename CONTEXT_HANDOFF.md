...
| Supabase anon key | `your_supabase_anon_key041QP5ThRwpPS1FMH6w_lF4B0Opp` |
| Supabase service role | `your_supabase_service_role_key591IB3zcNACSAQ_lDMOJrW1` |
| Resend API key | `REDACTED_ROTATE_KEY` |
